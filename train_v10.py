...
if __name__ == '__main__':
    model = YOLOv10(r'D:\Python_Project\yolov10-24.6.5\ultralytics\cfg\models\v10\backbone\yolov10n-VanillaNet.yaml')
    #model.load('yolov10n.pt') # loading pretrain weights
    model.train(data=r'D:\Python_Project\yolov10-24.6.5\ultralytics\cfg\datasets\kitti.yaml',
