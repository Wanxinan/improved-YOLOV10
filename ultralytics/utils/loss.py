...
from .metrics import bbox_iou, probiou,piou,bbox_inner_iou,shape_iou
...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask):
        ...
        # Inner-IoU  https://blog.csdn.net/m0_63774211/article/details/139405001
        #iou = bbox_inner_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], xywh=False, CIoU=True, ratio=0.7)
        # Inner-IoU

        # Shape-IoU  https://blog.csdn.net/m0_63774211/article/details/139407703
        #iou = shape_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], xywh=False)
        # Shape-IoU

        #Powerful-IoU  #https://blog.csdn.net/m0_63774211/article/details/139356706
